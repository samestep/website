      ...
      <main>
        ...
        <ul>
          <li>
            ...
            to simplify installation and usage of different tools, building this
            up as a shared resource for the differentiable programming community
            to maintain together as we move forward.
          </li>
          <li>
